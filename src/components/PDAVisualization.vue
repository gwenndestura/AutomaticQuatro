...
const PDA_CONFIGS = {
  ...
  2: {
    ...
    links: [
      ...
      { src: 'R10', tgt: 'R11',  label: '0' },
      { src: 'R11', tgt: 'R13',  label: '0,1', curve: 1.4, sweep: 1 },
      { src: 'R11', tgt: 'ACCEPT',label: 'Δ',  curve: 1.2, sweep: 1 },
  ...
  1: {
    nodes: [
      ...
      { id: 'rjS14', label: 'REJECT', type: 'reject', x: 1460, y:  80 },
      ...
      { id: 'rjS22', label: 'REJECT', type: 'reject', x: 1840, y: 200 },
      { id: 'rjS23', label: 'REJECT', type: 'reject', x: 2040, y: 200 },
      // S-state diamonds
      ...
      { id: 'S14', label: 'S14', type: 'state', x: 1460, y: 160 },
      { id: 'S15', label: 'S15', type: 'state', x: 1460, y: 420 },
      { id: 'S17', label: 'S17', type: 'state', x: 1100, y: 520 },
      { id: 'S18', label: 'S18', type: 'state', x: 1280, y: 520 },
      { id: 'S20', label: 'S20', type: 'state', x: 1640, y: 340 },
      { id: 'S21', label: 'S21', type: 'state', x: 1640, y: 160 },
