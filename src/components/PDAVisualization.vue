...
const PDA_CONFIGS = {
  ...
  2: {
    nodes: [
      ...
      { id: 'rj6',  label: 'REJECT', type: 'reject', x: 460,  y: 340 },
  ...
  1: {
    nodes: [
      ...
      { id: 'rjS15', label: 'REJECT', type: 'reject', x: 1310, y:  80 },
      { id: 'rjS17', label: 'REJECT', type: 'reject', x:  880, y: 630 },
      { id: 'rjS18', label: 'REJECT', type: 'reject', x: 1000, y: 630 },
